...
| **Core client redirect assets¶** | 🥇 **First redirect: ~8 KiB hot / ~14–15 KiB other; complete offline: ~231 KiB transfer / ~612 KiB decoded**                                          | 🥉 ~466 KiB transfer / ~1,980 KiB decoded                                                                                                        | 🥈 **~191 KiB transfer / ~694 KiB decoded**                                                                                                                               | Edge path                                                                                                                                          | ~525 KiB transfer / ~2,295 KiB decoded                                                                                                                         | Edge path                                                                                                                                                     |
