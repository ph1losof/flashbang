...
|                                  | **flashbang**                                           | **[unduck](https://github.com/T3-Content/unduck)** | **[unduckified](https://github.com/taciturnaxolotl/unduckified)** | **[ReBang](https://github.com/Void-n-Null/rebang)**    |
| -------------------------------- | ------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------ |
...
| **Analytics**                    | None†                                                   | Plausible                                         | None‡                                                             | Vercel Analytics + Speed Insights                     |
...
| **Snap chains**                  | Yes (2–8 sites)                                         | No                                                | No                                                                | No                                                    |
| **Feeling Lucky**                | Yes (configurable per-engine)                           | No                                                | No                                                                | No                                                    |
| **Configurable shortcut syntax** | Yes (separate bang/snap prefixes)                       | No (fixed `!`)                                    | No (fixed `!`)                                                    | No (fixed `!`)                                        |
| **Private fragment search**      | Yes (`#q=%s`, query not sent to server)                 | No                                                | No                                                                | No                                                    |
| **Address-bar suggestions**      | Built in (bang-aware + regular queries)                 | No                                                | Manual Google/DDG provider URL only                               | No                                                    |
| **Frecency-ranked suggestions**  | Yes (local usage; Chromium)                             | No                                                | No                                                                | No                                                    |
| **OpenSearch**                   | Yes (dynamic, self-host friendly)                       | No                                                | Yes                                                               | Yes                                                   |
| **Default engine setting**       | Yes                                                     | `localStorage` only; no UI                         | Yes                                                               | Yes                                                   |
| **Custom bangs**                 | Yes (IndexedDB)                                         | No                                                | Yes (`localStorage`)                                              | Yes (`localStorage`)                                  |
| **Advanced custom bangs**        | Regex captures, encoding modes, custom snap paths       | No                                                | No                                                                | No                                                    |
| **Bang catalog search**          | Yes (trigger, name, or domain)                          | No                                                | Yes                                                               | Yes                                                   |
| **Settings import/export**       | Yes                                                     | No                                                | Yes                                                               | No                                                    |
| **Automatic bang updates**       | Daily                                                   | No                                                | Daily                                                             | Monthly (PR)                                          |
| **Build tool**                   | Bun                                                     | Vite                                              | Vite                                                              | Vite                                                  |
| **Bang data for redirects**      | ~708 KB (packed trigger→URL lookup)                     | 2.7 MB (full metadata)                            | 1.5 MB (full metadata)                                            | ~208 KB inline + 1.23 MB lazy-loaded                  |
| **Parsed on**                    | SW thread (once per worker lifetime)                    | Main thread (every page load)                     | Main thread (every page load)                                     | Main thread (client fallback) or edge worker          |
